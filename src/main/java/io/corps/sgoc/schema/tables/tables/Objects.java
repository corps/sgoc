...
public class Objects extends org.jooq.impl.TableImpl<io.corps.sgoc.schema.tables.tables.records.ObjectsRecord> {
	 ...
	 */
	public static final io.corps.sgoc.schema.tables.tables.Objects OBJECTS = new io.corps.sgoc.schema.tables.tables.Objects();

	/**
	 * The class holding records for this type
	 */
	@Override
	public java.lang.Class<io.corps.sgoc.schema.tables.tables.records.ObjectsRecord> getRecordType() {
		return io.corps.sgoc.schema.tables.tables.records.ObjectsRecord.class;
	}
	 ...
	 */
	public final org.jooq.TableField<io.corps.sgoc.schema.tables.tables.records.ObjectsRecord, java.lang.Long> TIMESTAMP = createField("timestamp", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this);

	/**
	 * Create a <code>sgoc_test.objects</code> table reference
	 */
	public Objects() {
		super("objects", io.corps.sgoc.schema.tables.SgocTest.SGOC_TEST);
	}
	...
	public Objects(java.lang.String alias) {
		super(alias, io.corps.sgoc.schema.tables.SgocTest.SGOC_TEST, io.corps.sgoc.schema.tables.tables.Objects.OBJECTS);
	}
	 ...
	 */
	@Override
	public org.jooq.UniqueKey<io.corps.sgoc.schema.tables.tables.records.ObjectsRecord> getPrimaryKey() {
		return io.corps.sgoc.schema.tables.Keys.KEY_OBJECTS_PRIMARY;
	}
	 ...
	 */
	@Override
	public java.util.List<org.jooq.UniqueKey<io.corps.sgoc.schema.tables.tables.records.ObjectsRecord>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<io.corps.sgoc.schema.tables.tables.records.ObjectsRecord>>asList(io.corps.sgoc.schema.tables.Keys.KEY_OBJECTS_PRIMARY);
	}
	 ...
	 */
	@Override
	public io.corps.sgoc.schema.tables.tables.Objects as(java.lang.String alias) {
		return new io.corps.sgoc.schema.tables.tables.Objects(alias);
	}
}
