...
public class OnDeletePropagationTriggerTest {
  ...
  public void testName() throws Exception {
    Sync.ObjectWrapper basket = Fixtures.wrapABasket(
        Sync.ObjectWrapper.newBuilder().setId(Sync.ObjectId.newBuilder().setUuid("BasketId")).setDeleted(true).build(),
        basketBuilder.build());
    ...
    Sync.ObjectId appleId = apple.getId();
    Sync.ObjectId orangeId = orange.getId();
